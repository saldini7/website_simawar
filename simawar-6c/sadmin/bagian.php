                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex order-actions">
                                                    <a href="bagian-edit.php?id=<?php echo $row_bagian["id_bagian"] ?>" class="text-light bg-success border-0" title="Edit"><i class='bx bxs-edit'></i></a>
                                                    <a href="bagian-hapus.php?id=<?php echo $row_bagian["id_bagian"] ?>" class="ms-4 text-light bg-warning border-0" title="Hapus" onClick="return confirm('Apakah anda yakin ingin menghapus data ini...?')"><i class='bx bxs-trash'></i></a>
                                                </div>
                                            </td>
