                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($row_srt["status"] == 'New') { ?>
                                                    <a href="srt-klr-acc?id=<?php echo $row_srt["id_srt_klr"] ?>"> <span class="badge bg-light-danger text-danger w-100"><?php echo $row_srt["status"] ?></span></a>
                                            ...
                                            <td><?php echo $row_srt["untuk"] ?></a></td>
                                            <td><?php echo $row_srt["nm_user"] ?></td>
                                            <td><?php echo $row_srt["lampiran"] ?></td>
                                            <td><?php echo $row_srt["tgl_input"] ?></a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
