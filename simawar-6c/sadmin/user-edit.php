                    ...
                    <div class="col-xl-12 mx-auto">
                        ...
                        <div class="card border-top border-0 border-4 border-primary">
                            <div class="card-body px-5 pb-5">
                                ...
                                <hr>
                                <p>Apabila di blokir, maka User tidak akan bisa login
                                </p>
                                <form class="row g-3" method="POST" target="">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="number" class="form-control" name="telp" id="telp" value="<?php echo $row_karyawan["telp"] ?>" placeholder="Telepon aktik WA " required>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status" id="inlineRadio5" value="1" <?php if ($row_karyawan["status"] == 1) echo 'checked' ?>>
                                            <label class="form-check-label" for="inlineRadio5">Aktif</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status" id="inlineRadio6" value="0" <?php if ($row_karyawan["status"] == 0) echo 'checked' ?>>
