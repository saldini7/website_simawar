...
$id_srt = $_GET['id'];
$query_srt = "SELECT * FROM tbl_srt_msk WHERE id_srt_msk = '$id_srt'";
...
if (isset($_POST["submit"])) {
    ...
    if ($_FILES["file"]["error"] === 4) {
        ...
        $ekstensifileValid = ["pdf", "doc", "xls", "docx", "xlsx"];
        $ekstensifile = explode('.', $namafile);
        $ekstensifile = strtolower(end($ekstensifile));

        if (!in_array($ekstensifile, $ekstensifileValid)) {
            echo "<script>
        alert ('Yang Anda Update Bukan file.....!');
        history.go(-1);
        </script>";
            return false;
        }
    ...
    hal = '$hal', 
    dari = '$dari', 
    file = '$file' WHERE id_srt_msk = $id_srt";
...
<head>
    ...
    <title>Simawar - Update Surat Masuk</title>
</head>
            ...
            <div class="page-content">
                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item"><a href="user.php">Surat Masuk</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Update Surat Masuk</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-12 mx-auto">
                        <h6 class="mb-0 text-uppercase">Update Surat Masuk</h6>
                        <hr />
                        <div class="card border-top border-0 border-4 border-primary">
                            <div class="card-body px-5 pb-5">
                                <div class="card-title d-flex align-items-center">
                                    ...
                                    <h5 class="mb-0 text-primary">Update Surat Masuk</h5>
                                </div>
                                <hr>
                                <form class="row g-3" method="POST" target="" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" name="no_srt" id="no_srt" value="<?php echo $row_srt["no_srt"] ?>" placeholder="Nomor Surat Masuk" required>
                                    </div>

                                    <div class="col-12">
                                        <label for="tgl_srt" class="form-label">Tanggal Surat :</label>
                                        <input type="date" class="form-control" name="tgl_srt" id="tgl_srt" value="<?php echo $row_srt["tgl_srt"] ?>" placeholder=" Tanggal Surat Masuk" required>
                                    </div>

                                    <div class="col-12">
                                        <label for="lampiran" class="form-label">Lampiran :</label>
                                        <input type="text" class="form-control" name="lampiran" id="lampiran" value="<?php echo $row_srt["lampiran"] ?>" placeholder=" Lampiran Surat Masuk" required>
                                    </div>

                                    <div class="col-12">
                                        <label for="hal" class="form-label">Perihal :</label>
                                        <input type="text" class="form-control" name="hal" id="hal" value="<?php echo $row_srt["hal"] ?>" placeholder=" Perihal Surat Masuk" required>
                                    </div>

                                    <div class="col-12">
                                        <label for="dari" class="form-label">Dari :</label>
                                        <input type="text" class="form-control" name="dari" id="dari" value="<?php echo $row_srt["dari"] ?>" placeholder=" Surat Masuk Dari" required>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <label for="file" class="form-label">Update Surat :</label>
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary px-5" name="submit">edit</button>
