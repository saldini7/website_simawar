                    ...
                    <div class="col-xl-12 mx-auto">
                        ...
                        <div class="card border-top border-0 border-4 border-primary">
                            <div class="card-body px-5 pb-5">
                                ...
                                <hr>
                                <p>Password default otomatis dibuat, yaitu<stong>admin</stong>
                                </p>
                                <form class="row g-3" method="POST" target="">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="number" class="form-control" name="telp" id="telp" placeholder="Telepon aktik WA " required>
                                    </div>
                                    ...
                                    <input type="hidden" name="password" value="$2y$10$SmCrxbwFc.oOCPMnEGWm/uOG5p6yZvFEGlRTWY4kOaQT8UvKH1hGW">
